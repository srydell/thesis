...
The estimation of thermal averages can thus be done via arithmetic averaging of the form (2.4) by starting with some initial configuration $\mu_0$ and generating a chain $\mu_1,. . . , \mu_M$ via the Metropolis scheme.
