...
%\maketitle
% My name is Simon Rydell and this is my master thesis that was made here for the last 8 months. It is called \title and I will start off by giving a small overview of what I will present. Unfortunately, the paper is not back from the printing yet so I've provided a link in the footnote of all the slides.

% Random and self avoiding walks are commonplace in computational physics, where its used for everything from brownian motion to protein folding. Relating these walks to a lattice is often done to simplify the computer simulations, and spin models are often used for relating them to physical particle systems. One way to think about these structures is then as clusters of parallel spins, and this has been studied extensively.
% Here we will do something more profound, it turns out that the partition function of the dual transformation of these spin models have a geometric interpretation. We will take a look at classifying these structures as fractals, and especially using the Hausdorff dimension. We will see two common spin models, the Ising and the XY model, and finally I will compare our results to literature.
...
% First row
    \begin{columns}[c]
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=1\textwidth]{figures/largest_cluster_testing_nolattice.pdf}
        \end{figure}
        \column{1.5in}
        \begin{itemize}
...
% This talk is divided into four parts. I will first expand a bit on what a fractal is, what fractal dimension is and so on. This is to finally understand what the Hausdorff dimension of a loop fluctuation is mathematically. Then talk about the algorithms used for generating and working with the patterns that will be examined, and then finally talk about the two models used in this thesis.
...
% First row
    \begin{columns}[c]
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=\textwidth]{figures/square_divided.pdf}
        \end{figure}
    \column{1.5in}
        \begin{figure}[h!]
            \centering
            \includegraphics[width=\textwidth]{figures/sierpinski_divided2.pdf}
        \end{figure}
    \end{columns}
% Second row
    \begin{columns}[c]
...
\begin{frame}{Labeling and Dividing the Graph}
    \begin{columns}[c]
        ...
        \begin{column}{0.6\textwidth}  %%<--- here
            \begin{figure}[h!]
                \centering
                \includegraphics[width=0.8\textwidth]{figures/hk_grid.pdf}
            \end{figure}
        \end{column}
    \end{columns}
    \blfootnote{bit.ly/2qGMGnR}
...
\centering
    \begin{subfigure}{.45\textwidth}
        \centering
        \includegraphics[width=1.\linewidth]{figures/largest_cluster_testing_nolattice.pdf}
        \caption{Ising cluster : Self crossing}
    \end{subfigure}
    \begin{subfigure}{.45\textwidth}
        \centering
        \includegraphics[width=1.\linewidth]{figures/saw.pdf}
...
% TODO: Uncomment
   \animategraphics[width=\linewidth,loop]{10}{figures/3dxy_largest_cluster}{}{}
   \blfootnote{bit.ly/2qGMGnR}
\end{frame}
